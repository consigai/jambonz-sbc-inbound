...
class EcrRepositoryStack(cdk.Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        repository = ecr.Repository(self,
                       "ConsigjambonzSbcInboundRepo",
                       repository_name="consig-jambonz-sbc-inbound")

        jambonzSbcInbound_image_asset = ecr_assets.DockerImageAsset(self, "jambonzSbcInbound",
        ...
        ecrdeploy.ECRDeployment(self, f"DeployDockerImageSHA_{github_sha}",
                      src=ecrdeploy.DockerImageName(jambonzSbcInbound_image_asset.image_uri),
...
# Create Docker Repo
#
EcrRepositoryStack(app, "jambonzSbcInbound")
