...
class EcrRepositoryStack(cdk.Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        repository = ecr.Repository(self, 
                       "ConsigsbcInRepo",
                       repository_name="consig-sbc-in")

        sbcIn_image_asset = ecr_assets.DockerImageAsset(self, "sbcIn",
        ...
        ecrdeploy.ECRDeployment(self, "DeployDockerImageSHA",
                      src=ecrdeploy.DockerImageName(sbcIn_image_asset.image_uri),
